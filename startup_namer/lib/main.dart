...
class _EditPageState extends State<EditPage> {
  ...
  Widget build(BuildContext context) {
		final wordArguments = (ModalRoute.of(context)?.settings.arguments?? <List, String>{}) as Map;
...
class _RandomWordsState extends State<RandomWords> {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
							setState(() {
								Navigator.pushNamed(context, '/form', arguments: {'wordsList': repository.getAllList(), 'currentWord': null});
							});
						},
            tooltip: 'Add Name',
          ),
  ...
  Widget _buildRow(String pair) {
    ...
    return ListTile(
        ...
        onTap: () {
					setState(() {
						Navigator.pushNamed(context, '/form', arguments: {'wordsList': repository.getAllList(), 'currentWord': pair});
					});
				},
        trailing: Container(
            width: 100,
